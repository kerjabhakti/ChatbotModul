...
${ubah}OWNER : https://wa.me/6281374347075${ubah}

${ubah}SEBELUM MENGGUNAKAN BOT BACA 
SYARAT DAN KETENTUAN BOT !${ubah}

${garis}
${ubah}JOIN GROUP UNTUK INFORMASI BOT${ubah}
${garis}
...
JANGAN SPAM BOT, JIKA BOT TIDAK RESPON BISA TANYAKAN KE OWNER ATAU KAMU BISA JOIN GROUP ITEUNG V2 BOT
...
function snk() {
    return `Syarat dan Ketentuan *ITEUNG V2 BOT*
...
╠➥ *DONASI BISA MELALUI :*
╠➥ *GOPAY : 081374347075*
╠➥ *DANA/PULSA/OVO : 081374347075*
╠➥ *Donate Manja : https://sociabuzz.com/jxxzyshn/donate*
...
BISA VIA WA : https://wa.me/6281374347075
...
${garis}${ubah}
  ...
  NB : LIST DI ATAS UNTUK PEMBAYARAN VIA DANA, GOPAY & BANK BRI,
       VIA PULSA UP +5K. 
...
Contoh : *#tiktokstalk @ITEUNG V2 *

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *#igstalk @ITEUNG V2*

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *#smulestalk @ITEUNG V2*

            *「 YT SEARCH 」*

*[video]* Diisi dengan Judul Video yang valid tanpa tanda “[” dan “]”
Contoh : *#video ITEUNG V2*
